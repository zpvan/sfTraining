...
typedef enum {
    ...
    AUDIO_STREAM_PUBLIC_CNT       = AUDIO_STREAM_MUSIC_SUB + 1,
...
typedef enum {
    ...
    AUDIO_SOURCE_CMCC_KARAOK_MIC     = 1000,
    AUDIO_SOURCE_CMCC_KARAOK_SPEAKER = 1001,
...
enum {
    ...
    // MStar Android Patch Begin
    // Two mm play support speaker and line out
    AUDIO_DEVICE_OUT_LINE_OUT                  = 0x800000,
    AUDIO_DEVICE_OUT_BLUETOOTH_SPK             = 0x1000000,
    // Add output device for tunnel mode support
    AUDIO_DEVICE_OUT_DIRECT_PCM                = 0x2000000,
    AUDIO_DEVICE_OUT_RAW                       = 0x4000000,
    AUDIO_DEVICE_OUT_MULTI_CHANNEL             = 0x8000000,
    // MStar Android Patch End
    ...
    AUDIO_DEVICE_OUT_ALL      = (AUDIO_DEVICE_OUT_EARPIECE |
                                 ...
                                 AUDIO_DEVICE_OUT_RAW |
                                 AUDIO_DEVICE_OUT_MULTI_CHANNEL |
                                 // MStar Android Patch End
    ...
    // MStar Android Patch Begin
    /* Broadcom input mic */
    AUDIO_DEVICE_IN_BT_MIC                = AUDIO_DEVICE_BIT_IN | 0x80000,
    /* Mediatek input mic */
    AUDIO_DEVICE_IN_BLUETOOTH_MIC         = AUDIO_DEVICE_BIT_IN | 0x100000,
    AUDIO_DEVICE_IN_CAPTURE_DEVICE0       = AUDIO_DEVICE_BIT_IN | 0x200000,
    AUDIO_DEVICE_IN_CAPTURE_DEVICE1       = AUDIO_DEVICE_BIT_IN | 0x400000,
    // MStar Android Patch End
...
{
    device &= ~AUDIO_DEVICE_BIT_IN;
    if ((popcount(device) == 1) && (device & (AUDIO_DEVICE_IN_BT_MIC)))
        return true;
    else
        return false;
}
