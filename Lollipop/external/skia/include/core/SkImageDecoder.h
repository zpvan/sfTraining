...
public:
    ...
    // Set true to disable premultiply Alpha.
    void setDisablePreMultiplyAlpha(bool disable) { fDisablePreMultiplyAlpha = disable;}

    // Returns true if disable premultiply Alpha.
    bool getDisablePreMultiplyAlpha() {return fDisablePreMultiplyAlpha;}

    /** Let enable be true if the we try to use hardward decoder to decode image.
        The default setting is false. Set as true if need go hw decoder at first.
    */
    void setEnableHwDecode(bool enable) { fEnableHwDecode = enable; }

    /** Returns true if we are trying to use hardward decoder to decode image.
        The default setting is false.
    */
    bool getEnableHwDecode() { return fEnableHwDecode; }
...
// MStar Android Patch Begin
protected:
    bool                    fDisablePreMultiplyAlpha;
    bool                    fEnableHwDecode;
// MStar Android Patch End
};
