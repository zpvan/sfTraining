...
void MessageQueue::Handler::handleMessage(const Message& message) {
    // MStar Android Patch Begin
    EventThread::Connection *conn = (EventThread::Connection*)mQueue.mEvents.get();
    if(conn->mEventDroped) {
        ALOGD("MessageQueue::handleMessage() begin: message.what=%d", message.what);
    }
    // MStar Android Patch End
    switch (message.what) {
        case INVALIDATE:
    ...
    // MStar Android Patch Begin
    if(conn->mEventDroped) {
        ALOGD("MessageQueue::handleMessage() end: message.what=%d", message.what);
    }
    // MStar Android Patch End
}
