...
# Enable eglSwapBuffersWithDamageEXT only for Mali Utgard GPU
ifneq ($(filter Mali-%,$(TARGET_BOARD_PLATFORM_GPU)),)
ifeq ($(filter Mali-T%,$(TARGET_BOARD_PLATFORM_GPU)),)
    LOCAL_CFLAGS += -DENABLE_EGL_SWAP_BUFFERS_WITH_DAMAGE
endif
endif
