...
public:
    ...
    uint32_t initCaptureData(const intptr_t captureData, int opTimingWidth, int opTimingHeight);
    void releaseCaptureData(uint32_t textrue);
    virtual void setR2YTransform(bool flag) = 0;
    virtual void enableSDR2HDR(bool enable) = 0;
    // MStar Android Patch End
};
