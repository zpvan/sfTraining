...
public:
    ...
    public:
        enum {
            ...
            R2Y_MATRIX_OFF        =       0x00000000,
            R2Y_MATRIX_ON         =       0x00000040,
            R2Y_MATRIX_MASK       =       0x00000040,
            SDR2HDR_MATRIX_OFF        =       0x00000000,
            SDR2HDR_MATRIX_ON         =       0x00000080,
            SDR2HDR_MATRIX_MASK       =       0x00000080,
        ...
        // MStar Android Patch Begin
        inline bool hasR2YMatrix() const {
            return (mKey & R2Y_MATRIX_MASK) == R2Y_MATRIX_ON;
        }
        inline bool hasSDR2HDRMatrix() const {
            return (mKey & SDR2HDR_MATRIX_MASK) == SDR2HDR_MATRIX_ON;
        }
        // MStar Android Patch End
