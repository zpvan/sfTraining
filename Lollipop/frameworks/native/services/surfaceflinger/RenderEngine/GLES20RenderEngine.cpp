...
void GLES20RenderEngine::setR2YTransform(bool flag) {
    if (flag) {
        mState.setR2YTransform(R2Y::Transform::BT_601_NARROW);
    } else {
        mState.setR2YTransform(R2Y::Transform::NONE);
    }
}

void GLES20RenderEngine::enableSDR2HDR(bool enable) {
    mState.enableSDR2HDR(enable);
}
