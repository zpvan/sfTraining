...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_IPTV_AUDIO_TRACK = 1010;

    // MStar Android Patch Begin
    /** Please refer to frameworks/native/include/android/keycodes.h for
     * the maximum value of LAST_KEYCODE
     */
    private static final int LAST_KEYCODE = 281;
    ...
    public static final boolean isSystemKey(int keyCode) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_IPTV_AUDIO_TRACK:
                return true;
        }
