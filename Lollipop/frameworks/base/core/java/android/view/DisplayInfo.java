...
public final class DisplayInfo implements Parcelable {
    ...
    private void getMetricsWithSize(DisplayMetrics outMetrics, CompatibilityInfo compatInfo,
        ...
        // 4k2k mode has change displayifo ,so don't need change displayMetrics.
        if (!compatInfo.equals(CompatibilityInfo.DEFAULT_COMPATIBILITY_INFO) && !compatInfo.forceTo4k2kSize()) {
