...
public final class Display {
    ...
    private void updateDisplayInfoLocked() {
        ...
        CompatibilityInfo compatInfo = mDisplayAdjustments.getCompatibilityInfo();
        if (compatInfo != null & !compatInfo.equals(CompatibilityInfo.DEFAULT_COMPATIBILITY_INFO)) {
            compatInfo.applyToDisplayInfo(newInfo);
        }
