...
public class PackageParser {
    ...
    */
    ...
    public Package parsePackage(File sourceFile, String destCodePath,
        ...
        try{
            Package pkg= parseMonolithicPackage(sourceFile, flags);
            return pkg;
        }catch(PackageParserException e){
            Log.e(TAG, "Error sourceFile="+sourceFile);
            return null;
        }
    }
    // MStar Android Patch End, for C2_CMCC
...
*/
    ...
    private boolean parseBaseApplication(Package owner, Resources res,
        ...
        // MStar Android Patch Begin
        if (pkgName.contains("net.sunniwell.app.ott.chinamobile") ||
                    pkgName.contains("com.bestv.ott.baseservices")) {
