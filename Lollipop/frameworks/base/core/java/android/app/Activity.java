...
public class Activity extends ContextThemeWrapper
    ...
    protected void onResume() {
        ...
        mVideoRatio = SystemProperties.get("mstar.video.ratio","1");
		if(this.toString().contains("com.hpplay.")&& mVideoRatio.equals("1"))
    ...
    void dumpInner(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        writer.print(innerPrefix); writer.print("Current using DisplayInfo=");
                writer.println(mWindowManager.getDefaultDisplay());
