...
public class Dialog implements DialogInterface, Window.Callback,
     ...
     */
    public void show() {
        Log.e(TAG, "test by lyt this apk is " + this);
        if(this.toString().contains("com.bestv.ott.ui.view.LoaddingBar")){
            Log.e(TAG, "test by lyt this apk is com.bestv.ott.ui.view.LoaddingBar");
            SystemProperties.set("cmcc.bestvota.update", "1");
        }
        if (mShowing) {
            if (mDecor != null) {
