    ...
    public static class Builder {
        ...
        public Builder setCapturePreset(int preset) {
            switch (preset) {
                ...
                // MStar Android Patch Begin CMCC
                case MediaRecorder.AudioSource.CMCC_KARAOK_SPEAKER:
                case MediaRecorder.AudioSource.CMCC_KARAOK_MIC:
                // MStar Android Patch End CMCC
                    mSource = preset;
                    break;
                default:
        ...
        public Builder setInternalCapturePreset(int preset) {
            // MStar Android Patch Begin CMCC
            if(preset == 1000 || preset == 1001){
                Log.d(TAG, "CMCC MIGU patch force change audio source, old source=" + preset);
                preset = (preset==1000)?10:((preset==1001)?11:preset);
                Log.d(TAG, "CMCC MIGU patch force change audio source, new source=" + preset);
            }
            // MStar Android Patch End CMCC
