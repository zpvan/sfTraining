...
public class MediaRecorder implements MediaRecorderEx
{
    ...
    public final class AudioSource {
       ...
       */
        ...
        //MStar Android Patch for CMCC start
        /** karaoke source for MiGu music karaoke capture sound.
          * MCC_KARAOK_MIC: capture microphone original sound.
          * CMCC_KARAOK_SPEAKER: capture sound of after microphone and music mixing 
         */
        public static final int CMCC_KARAOK_MIC = 10;
        public static final int CMCC_KARAOK_SPEAKER = 11;
        //MStar Android Patch for CMCC start
    ...
    public final class OutputFormat {
       ...
       */
        ...
        // MStar Android Patch Begin
        /** @hide MStar voip */
        public static final int OUTPUT_FORMAT_VVOIP = 100;

        /** @hide MStar livecap video */
        public static final int OUTPUT_FORMAT_LIVECAP_VIDEO = 101;
        // MStar Android Patch End
    };
    ...
    public static final int getAudioSourceMax() {
        return AudioSource.CMCC_KARAOK_SPEAKER;
    }
    ...
    public void setProfile(CamcorderProfile profile) {
        ...
        // MStar Android Patch Begin
        // Support LIVECAP Video
        mOutputFormat = profile.fileFormat;
        Log.v(TAG, "mOutputFormat = "+ mOutputFormat);
        // MStar Android Patch End
    ...
    {
        // MStar Android Patch Begin
        // Add debug message to support LIVECAP Video
        Log.v(TAG, "prepare: mOutputFormat = "+ mOutputFormat);
        if ((mOutputFormat != OutputFormat.OUTPUT_FORMAT_LIVECAP_VIDEO)) {
            if (mPath != null) {
                Log.v(TAG, "mPath = " + mPath);
                if ((!mPath.equals("mstar://livecapvideo.record"))) {
