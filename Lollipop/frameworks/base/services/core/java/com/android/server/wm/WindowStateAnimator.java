...
class WindowStateAnimator {
    ...
    SurfaceControl createSurfaceLocked() {
        ...
        if (mSurfaceControl == null) {
            ...
            left -= w.mEnforceSizeCompat? attrs.surfaceInsets.left * mDsDx:attrs.surfaceInsets.left;
            top -= w.mEnforceSizeCompat? attrs.surfaceInsets.top * mDtDy:attrs.surfaceInsets.top;
    ...
    void setWallpaperOffset(RectF shownFrame) {
        ...
        // MStar Android Patch Begin
        int offsetL = mWin.mEnforceSizeCompat? (int)(attrs.surfaceInsets.left * mDsDx + .5f):attrs.surfaceInsets.left;
        int offsetR = mWin.mEnforceSizeCompat? (int)(attrs.surfaceInsets.top * mDtDy + .5f):attrs.surfaceInsets.top;
        final int left = ((int) shownFrame.left) - offsetL;
        final int top = ((int) shownFrame.top) -offsetR;
        // MStar Android Patch Begin
