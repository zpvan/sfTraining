...
void CheckOffsets(void) {
    ...
    CHECK_MEMBER_AT(framebuffer_device_t, osdWidth, 108, 164);
    CHECK_MEMBER_AT(framebuffer_device_t, osdHeight, 112, 168);
    CHECK_MEMBER_AT(framebuffer_device_t, reserved, 116, 172);
    ...
    CHECK_MEMBER_AT(framebuffer_device_t, read, 160, 240);
    CHECK_MEMBER_AT(framebuffer_device_t, reSetGopSize, 164, 248);
    CHECK_MEMBER_AT(framebuffer_device_t, getAdjustValue, 168, 256);
    CHECK_MEMBER_AT(framebuffer_device_t, setPanelMode, 172, 264);
    CHECK_MEMBER_AT(framebuffer_device_t, getPanelMode, 176, 272);
    CHECK_MEMBER_AT(framebuffer_device_t, postSecFb, 180, 280);
    CHECK_MEMBER_AT(framebuffer_device_t, reserved_proc, 184, 288);
    ...
    CHECK_MEMBER_AT(hwc_layer_1_t, _pad, 132, 156);
    ...
    CHECK_MEMBER_AT(hwc_composer_device_1_t, reserved_proc, 188, 368);
