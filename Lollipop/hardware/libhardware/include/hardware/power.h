...
typedef struct power_module {
    ...
    /*
     * (*updateStrState)() is called when sleeping/waking up to do
     * sn/mi driver suspend/resume.
     */
    void (*updateStrState)(struct power_module *module, int sleep);

    /*
     * (*shutdown)() is called to shut down system in non-str case.
     */
    void (*shutdown)(struct power_module *module);
