...
enum {
    TV_INPUT_SIDEBAND_TYPE_TV = 1,
    TV_INPUT_SIDEBAND_TYPE_MM,
    TV_INPUT_SIDEBAND_TYPE_MM_XC = TV_INPUT_SIDEBAND_TYPE_MM,
    TV_INPUT_SIDEBAND_TYPE_MM_GOP,
};
...
#ifdef __cplusplus
typedef struct sideband_handle : public native_handle
{
#else
typedef struct sideband_handle
{
    struct native_handle nativeHandle;
#endif

    /* send infor from HWC to client */
    int pipe_in[2];
    /* send infor from client to HWC */
    int pipe_out[2];
    /* indeicate iff sidebandhadle is actvie */
    int isActive;
    /* sideband streadm type , TV or MM */
    int sideband_type;
    /* indicate specified ID of device */
    int device_id;
    /* indicate specified ID of stream*/
    int stream_id;
    /* indicate specified window of stream*/
    int window_type;
    /* indicate height of video window*/
    int height;
    /* indicate width of video window*/
    int width;
    /* indicate x-coordinate of video window*/
    int x;
    /* indicate y-coordinate of video window*/
    int y;
