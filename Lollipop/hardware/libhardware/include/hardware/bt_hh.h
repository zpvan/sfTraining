...
// MStar Android Patch Begin
/** Callback to notify battery report found in a remote HID device
*/
typedef void (* bthh_battery_report_found_callback)(bt_bdaddr_t *bd_addr,
                uint16_t logical_min, uint16_t logical_max);

/** Callback for battery level
 */
typedef void (* bthh_battery_level_callback)(bt_bdaddr_t *bd_addr, bthh_status_t hh_status,
...
typedef struct {
    ...
    // MStar Android Patch Begin
    bthh_battery_report_found_callback  bl_report_found_cb;
    bthh_battery_level_callback         battery_level_cb;
...
typedef struct {
    ...
    bt_status_t (*get_battery_level)(bt_bdaddr_t *bd_addr);
