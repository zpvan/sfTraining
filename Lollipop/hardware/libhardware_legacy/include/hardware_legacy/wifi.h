...
/**
 * Get the number of available wifi devices
 */
int get_wifi_device_num();

/**
 * Detect if the wifi device to support p2p or not
 */
int is_support_p2p();

/**
 * Detect if the wifi device to support softap or not
 */
